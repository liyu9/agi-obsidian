...
本报告面向 2000 人规模互联网公司**统一部署多类 AI Agent**（Claude Code / OpenClaw / Hermes 等）的记忆共享与治理需求。核心结论：推荐**方案3**——以「知识库」为中心抽象、**OpenViking** 为底座、叠加多实例物理隔离与③层授权中心，实现跨 Agent 记忆复用、部门/个人/会话三级隔离与企业级合规治理。
