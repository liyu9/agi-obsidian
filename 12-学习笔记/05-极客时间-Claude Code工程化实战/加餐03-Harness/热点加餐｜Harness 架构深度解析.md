...
**模型主动停止**——Claude 认为任务完成，生成纯文本回复，不再请求工具调用。API 返回  `stop_reason: "end_turn"`。**达到最大轮次**——Harness 设置了  `--max-turns`  限制，防止无限循环。
...
---
来源：极客时间
链接：https://time.geekbang.org/column/article/958033
日期：2026-05-07
