...
理解**“信噪比”框架**，学会判断哪些任务适合委托给子代理。掌握**子代理输出格式设计的方法论**，而非只学一个固定模板。
...
你的项目中还有哪些高噪声输出的任务？它们适合用子代理来处理吗？为什么？如果要创建一个“构建日志分析器“（分析 webpack/vite 等构建工具的输出），你会怎么设计它的 prompt？你会让这个 SubAgent 输出什么？
...
---
来源：极客时间
链接：https://time.geekbang.org/column/article/944525
日期：2026-05-07
