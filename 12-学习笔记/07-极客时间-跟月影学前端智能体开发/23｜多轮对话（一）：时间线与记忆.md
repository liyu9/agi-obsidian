...
- **目的表（purpose table）：****这也是一份配置表，用于思考的 Agent 根据时间线和记忆，参考目的表来筛选出当前轮次的目的，根据目的来生成一组具体的****行动方针（actions）**，对话 Agent 会根据候选人的回答和行动方针，参考目的表来进行下一轮的提问。

下面是一个典型的对话、分析和思考配合过程的示意图。

![](assets/20260512-881068-01-头图.png)
...
![](assets/20260512-881068-02-图片1.gif)
...
---
来源：极客时间
链接：https://time.geekbang.org/column/article/881068
日期：2026-05-12
