...
![](assets/20260512-868684-01-头图.png)
...
![](assets/20260512-868684-02-图片1.gif)
...
首先，在[https://klingai.kuaishou.com/]()注册可灵 AI，登录后，点击左下角“开发者平台”链接，可以进入[控制台]()。
...
![](assets/20260512-868684-03-图片2.gif)
...
然后使用 token 进行请求图片生成。可灵 AI 也是异步读写分离，先请求图片生成接口，获取 task_id，然后再通过 task_id 进行轮询直到生成完毕。有一个细节的区别是，可灵 AI 的轮询状态接口只能查询到状态，没有生成的进度条，所以我去掉了显示进度条的前端逻辑。
...
---
来源：极客时间
链接：https://time.geekbang.org/column/article/868684
日期：2026-05-12
