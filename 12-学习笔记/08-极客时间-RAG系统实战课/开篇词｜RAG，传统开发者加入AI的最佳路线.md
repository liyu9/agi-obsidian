...
![](assets/20260512-806059-01-头图.jpg)
...
我们没有使用 OpenAI / Azure GPT 大模型，而是使用了免费的百度文心大模型。我们没有使用 Faiss 来存储向量，而是使用了有完善 UI 支持、门槛最低的 Pgvector。我们没有使用 OpenAI / Azure 嵌入模型，而是使用了免费的、开源的、不需要 GPU 支持也能跑得很好的智谱 BPE 嵌入模型。为了让大家专注于 RAG 学习本身，我们示例代码的函数和变量尽量使用中文。在最后一节课，再使用 AI 将这些函数和变量改成规范化的英文。

最后，我们先睹为快，一起预览一下课程里实战案例的效果。

其中实战案例 1 是这样的。

![](assets/20260512-806059-02-图片1.jpg)

实战案例 2 是这样的。

![](assets/20260512-806059-03-图片2.jpg)

实战案例 3 是这样的。

![](assets/20260512-806059-04-图片3.jpg)

![](assets/20260512-806059-05-图片4.jpg)
...
---
来源：极客时间
链接：https://time.geekbang.org/column/article/806059
日期：2026-05-12
