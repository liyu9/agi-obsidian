...
![](assets/20260512-79762-01-头图.png)

![](assets/20260512-79762-02-图片1.png)
...
![](assets/20260512-79762-03-图片2.png)

![](assets/20260512-79762-04-图片3.png)

所以 TF-IDF=0.02*(-0.0414)=-8.28e-4。

针对“bayes”，计算 TF-IDF 值：

![](assets/20260512-79762-05-图片4.png)

![](assets/20260512-79762-06-图片5.png)
...
![](assets/20260512-79762-10-图片9.jpg)

**基于分词的数据准备**，包括分词、单词权重计算、去掉停用词；**应用朴素贝叶斯分类进行分类**，首先通过训练集得到朴素贝叶斯分类器，然后将分类器应用于测试集，并与实际结果做对比，最终得到测试集的分类准确率。
...
![](assets/20260512-79762-11-图片10.png)
...
![](assets/20260512-79762-12-图片11.png)

训练集放到 train 文件夹里，测试集放到 test 文件夹里，停用词放到 stop 文件夹里。

![](assets/20260512-79762-13-图片12.png)
...
---
来源：极客时间
链接：https://time.geekbang.org/column/article/79762
日期：2026-05-12
